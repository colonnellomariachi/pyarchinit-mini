...
DSN = "postgresql://admin_pyarchinit:xanu8ese@10.0.1.6:5432/pyarchinit_v2"
...
```bash
sshpass -p '@@rustaq' scp -o ConnectTimeout=15 -o PreferredAuthentications=password -o PubkeyAuthentication=no \
  scripts/build_regression_fixture.py ganesh@10.0.1.13:/tmp/
sshpass -p '@@rustaq' ssh -o PreferredAuthentications=password -o PubkeyAuthentication=no ganesh@10.0.1.13 \
